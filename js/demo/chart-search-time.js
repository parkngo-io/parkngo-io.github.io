...
var myLineChart = new Chart(ctx, {
  ...
  data: {
    ...
    },
    {
      ...
      yAxisID: 'A',
      lineTension: 0.3,
      backgroundColor: "rgba(248, 204, 137)",
      borderColor: "rgba(248, 204, 137)",
      pointRadius: 5,
      pointBackgroundColor: "rgb(248, 204, 137)",
      pointBorderColor: "rgb(248, 204, 137)",
      pointHoverRadius: 5,
      pointHoverBackgroundColor: "rgb(248, 204, 137)",
      pointHitRadius: 50,
      pointBorderWidth: 2,
